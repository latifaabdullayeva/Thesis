...
\end{table}
%%%%%%
\footnotetext{The meaning of abbreviations in Table~\ref{table:medianMS1}:\\
$^{S}$ sophisticated, $^{C}$ contemporary, $^{U}$ unpretentious music$^{E}$ extraversion,
$^{A}$ agreeableness, $^{C}$ conscientiousness, $^{N}$ neuroticism, and $^{O}$ openness personality trait.}
%%%%%%
\begin{figure}[hbt!]
    \centering
    ...
    \label{fig:MS1}
\end{figure}
\footnotetext{The meaning of abbreviations in Figure~\ref{fig:MS1}:\\
$^{***}$ p\textsubscript{adj}<.001, $^{**}$ p\textsubscript{adj}<.01,
...
\end{table}
%%%%%%
\footnotetext{The meaning of abbreviations in Table~\ref{table:medianMS2}:\\
...
\begin{figure}[hbt!]
    ...
    \label{fig:MS2}
\end{figure}
\footnotetext{The meaning of abbreviations in Figure~\ref{fig:MS2}:\\
$^{***}$ p\textsubscript{adj}<.001, $^{**}$ p\textsubscript{adj}<.01,
$^{*}$ p\textsubscript{adj}<.05 and $^{ns}$ p\textsubscript{adj}>.05.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%
\footnotetext{The meaning of abbreviations in Table~\ref{table:medianML1}:\\
$^{Y}$ yellow, $^{O}$ orange, $^{T}$ turquoise, $^{B}$ blood-red and $^{P}$ pink color.}
%%%%
\begin{figure}[hbt!]
    \centering
    ...
    \label{fig:ML1}
\end{figure}
\footnotetext{The meaning of abbreviations in Figure~\ref{fig:ML1}:\\
$^{***}$ p\textsubscript{adj}<.001, $^{**}$ p\textsubscript{adj}<.01,
$^{*}$ p\textsubscript{adj}<.05 and $^{ns}$ p\textsubscript{adj}>.05.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\footnotetext{The meaning of abbreviations in Table~\ref{table:medianML2}:\\
$^{E}$ extraversion, $^{A}$ agreeableness, $^{C}$ conscientiousness, $^{N}$ neuroticism
and $^{O}$ openness personality trait.}
...
\begin{figure}[hbt!]
    ...
    \label{fig:ML2}
\end{figure}
\footnotetext{The meaning of abbreviations in Figure~\ref{fig:ML2}:\\
$^{***}$ p\textsubscript{adj}<.001, $^{**}$ p\textsubscript{adj}<.01,
$^{*}$ p\textsubscript{adj}<.05 and $^{ns}$ p\textsubscript{adj}>.05.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[hbt!]
    ...
    \end{center}
\end{table}
\footnotetext{The meaning of abbreviations in Table~\ref{table:medianMM1}:\\
$^{L1}$ vibration level-1, $^{L2}$ level-2, $^{L3}$ level-3, $^{L4}$ level-4 and $^{L5}$ level-5.}
...
\begin{figure}[hbt!]
    ...
    \label{fig:MM1}
\end{figure}
\footnotetext{The meaning of abbreviations in Figure~\ref{fig:MM1}:\\
$^{***}$ p\textsubscript{adj}<.001, $^{**}$ p\textsubscript{adj}<.01,
$^{*}$ p\textsubscript{adj}<.05 and $^{ns}$ p\textsubscript{adj}>.05.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[hbt!]
    ...
    \end{center}
\end{table}
\footnotetext{The meaning of abbreviations in Table~\ref{table:medianMM2}:\\
$^{E}$ extraversion, $^{A}$ agreeableness, $^{C}$ conscientiousness, $^{N}$ neuroticism
and $^{O}$ openness personality trait.}
...
\begin{figure}[hbt!]
    ...
    \label{fig:MM2}
\end{figure}
\footnotetext{The meaning of abbreviations in Figure~\ref{fig:MM2}:\\
$^{***}$ p\textsubscript{adj}<.001, $^{**}$ p\textsubscript{adj}<.01,
$^{*}$ p\textsubscript{adj}<.05 and $^{ns}$ p\textsubscript{adj}>.05.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[hbt!]
    ...
    \end{center}
\end{table}
\footnotetext{The meaning of abbreviations in Table~\ref{table:medianMT1}:\\
$^{Y}$ yellow, $^{O}$ orange, $^{T}$ turquoise, $^{B}$ blood-red and $^{P}$ pink color.}
...
\begin{figure}[hbt!]
    ...
    \label{fig:MT1}
\end{figure}
\footnotetext{The meaning of abbreviations in Figure~\ref{fig:MT1}:\\
$^{***}$ p\textsubscript{adj}<.001, $^{**}$ p\textsubscript{adj}<.01,
$^{*}$ p\textsubscript{adj}<.05 and $^{ns}$ p\textsubscript{adj}>.05.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[hbt!]
    ...
    \end{center}
\end{table}
\footnotetext{The meaning of abbreviations in Table~\ref{table:medianMT2}:\\
$^{E}$ extraversion, $^{A}$ agreeableness, $^{C}$ conscientiousness, $^{N}$ neuroticism
and $^{O}$ openness personality trait.}
...
\begin{figure}[hbt!]
    ...
    \label{fig:MT2}
\end{figure}
\footnotetext{The meaning of abbreviations in Figure~\ref{fig:MT2}:\\
$^{***}$ p\textsubscript{adj}<.001, $^{**}$ p\textsubscript{adj}<.01,
$^{*}$ p\textsubscript{adj}<.05 and $^{ns}$ p\textsubscript{adj}>.05.}
