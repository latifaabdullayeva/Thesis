...
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Setting up the Philips Hue bridge}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[scale=0.55]{PhilipsHue.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Questionnaires for the user study}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[scale=0.8]{Demographics.pdf}
